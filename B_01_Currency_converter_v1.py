...
class Converter:
    ...
    def __init__(self):
        ...
        button_details_list = [
            ["To NZD", "#990099", lambda: self.check_temp(c.ABS_ZERO_FAHRENHEIT), 0, 0],
            ["To AUD", "#009900", lambda: self.check_temp(c.ABS_ZERO_CELSIUS), 0, 1],
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        # list and loop to set background colour on everything expect the buttons
...
class ExportHistory:
    ...
    def __init__(self, partner, calculations):
        ...
        # background colour and text for calculation areas
